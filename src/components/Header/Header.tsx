...
const Header: React.FC<HeaderProps> = ({ onShowThought }) => {
  ...
  return (
    <header className="header">
      ...
      <div className="header-center">
        <a
          href="https://leetcode.cn/problems/find-the-duplicate-number/"
          target="_blank"
          rel="noopener noreferrer"
          className="title-link"
        >
          <h1 className="title">287. 寻找重复数</h1>
        </a>
      </div>
      
      <div className="header-right">
        <button className="thought-btn" onClick={onShowThought}>
          💡 算法思路
        </button>
